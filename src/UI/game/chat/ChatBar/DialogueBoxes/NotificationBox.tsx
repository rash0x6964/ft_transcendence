...
export default function NotificationBox({ boxRef }: Props) {
  ...
  return (
    <motion.div
      ...
      className="w-[35rem] h-1/2 origin-bottom-left gap-4 flex flex-col  drop-shadow-md gradient-border-2 absolute bottom-0 ml-14 pt-3 pl-6 pr-4  rounded-md mb-24 z-50 "
    >
