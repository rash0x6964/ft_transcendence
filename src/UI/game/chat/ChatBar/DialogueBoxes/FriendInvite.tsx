    ...
    <div className="flex justify-between sm:w-[28rem] mr-4">
      <div className="flex ml-4">
        <Avatar
          ...
          src={friendData?.friend?.avatarUrl}
      ...
      {!inviteSent && (
        <MainButton
          ...
          className="h-fit px-4 py-3 text-xs font-semibold rounded-sm my-auto"
        >
          Invite
        </MainButton>
      )}
      ...
      {inviteSent && (
        <span className="text-sm  text-primary my-auto">Invite Sent</span>
      )}
    </div>
  )
}
