...
export default function PlayerCard({ className, playerName, RP: rankedPoints, level, playerImage, onClick }: Props) {
	return (
		...
		<button onClick={onClick} className={`drop-shadow-lg bg-gradient-to-b h-96 w-[15rem] from-backdrop to-mirage  transition-transform hover:opacity-70 hover:scale-105  pb-2  shadow border-slate-500 rounded-xl  gradient-border ${className}`}>
