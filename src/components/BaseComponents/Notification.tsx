...
export default function Notification({ className, notifData }: Props) {


	if (notifData.type == "error")
		return (
			<div className={`bg-backdrop w-[26rem]  py-2 px-4 rounded-lg  border border-red-500 fixed z-[100] transition-all  right-0 mb-2 mr-20 ${className}`}>
